...
/**
 * Test for transaction WIKJT00401MXTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/WIKJT00401MXTest.xml" })
public class WIKJT00401MXTransactionTest {

	@Autowired
	private WIKJT00401MXTransaction transaction;
